...
/// </summary>
/// <returns></returns>
sf::Angle SceneNode::GetWorldRotation() const
{
	// https://www.sfml-dev.org/documentation/3.0.0/classsf_1_1Angle.html
...
{
	// Returning the scene category caused multiple items in the scene to trigger the shoot event, changed to default category to stop this bug
